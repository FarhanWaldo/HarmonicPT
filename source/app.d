...
void main( string[] args)
{
    ...
    MakeSphereSurfacePrim( vec3( 0.0f, 1.0f, 4.5f ), 3.0f, &plasticMtl );
    ...
    import light;   
    auto sph_lightGeo = MakeSphere( vec3( 0.0f, 8.0f, -1.0f ), 4.0f );
    ...
    writeln("Writing image to disk at " ~ imageOutputPath );
    ImageBuffer_WriteToPng( &displayImage, cast(char*) imageOutputPath.toStringz );
}
